...
import ru.code4fun.demo.GatewayApp;
import ru.code4fun.demo.config.Constants;
import ru.code4fun.demo.domain.Authority;
import ru.code4fun.demo.domain.User;
import ru.code4fun.demo.repository.AuthorityRepository;
import ru.code4fun.demo.repository.UserRepository;
import ru.code4fun.demo.security.AuthoritiesConstants;
import ru.code4fun.demo.service.MailService;
import ru.code4fun.demo.service.UserService;
import ru.code4fun.demo.service.dto.PasswordChangeDTO;
import ru.code4fun.demo.service.dto.UserDTO;
import ru.code4fun.demo.web.rest.errors.ExceptionTranslator;
import ru.code4fun.demo.web.rest.vm.KeyAndPasswordVM;
import ru.code4fun.demo.web.rest.vm.ManagedUserVM;

...
import ru.code4fun.demo.config.audit.AuditEventConverter;
import ru.code4fun.demo.domain.PersistentAuditEvent;
...
import static ru.code4fun.demo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
